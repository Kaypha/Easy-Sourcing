    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
            ...
            <li class="dropdown"><a  class="nav-link scrollto active"href="#hero"><span>Company</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
          ...
          <li><a class="nav-link scrollto" href="#about">About</a></li>
            <li class="dropdown"><a href="#portfolio"><span>Products</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="#">Requisition & sourcing pipeline</a></li>
                  <li><a href="#">Supplier Management</a></li>
                  <li><a href="#">Catalog Management</a></li>
                  <li><a href="#">Integration</a></li>
                  <li><a href="#">Reporting & Big Data Analytics</a></li>
                   <li><a href="#">E-Sourcing</a></li>
                </ul>
              </li>
          <li><a class="nav-link scrollto" href="#pricing">Pricing</a></li>
           <li><a class="nav-link scrollto" href="#testimonials">Team</a></li>
        
          <li><a class="nav-link scrollto" href="#contact1">Get a Free Demo</a></li>
        ...
        <div class="tab-content" data-aos="fade-up">
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row">
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src=" {{ asset('img/about-us.png') }} " alt="" class="img-fluid">
              </div>
            </div>
          </div>
...
<div class="row portfolio-container" data-aos="fade-up">
           ...
           <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-img"><img src="{{ asset('img/sourcing.jpeg') }}" class="img-fluid" alt=""></div>
           ...
           <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-img"><img src=" {{ asset('img/supply.jfif') }}" class="img-fluid" alt=""></div>
            <div class="" style="opacity: 0.7; background-color: white">
              <h4 >Supplier Management   </h4>
                  ...
                  <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-img"><img src=" {{ asset('img/catalog.jpg') }}" class="img-fluid" alt=""></div>
            <div class="" style="opacity: 0.7; background-color: white">
           ...
           <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-img"><img src="{{ asset('img/esourcing.png') }}" class="img-fluid" alt=""></div>
            <div class="" style="opacity: 0.7; background-color: white">
              <h4 >E-Sourcing   </h4>
            </div>
          </div>
                  ...
                  <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-img"><img src="{{ asset('img/data.png') }}" class="img-fluid" alt=""></div>
            <div class="" style="opacity: 0.7; background-color: white">
  ...
  <!--  <section id="faq" class="faq">
    ...
    <!-- ======= Contact Section2 ======= -->
    <section id="contact" class="contact" style="margin-top: 10%;">
      <div class="container d-flex">
        <div class="col-md-6">
          <img src="{{URL::asset('img/about-us.png') }}" style="height: 300px; 100%">
        </div>
        <div class="col-md-6">
        <form>
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Company Email address</label>
  ...
  <div class="mb-3 form-check">
   ...
   <div class="mb-3 form-check">
          ...
          <button type="submit" class="btn btn-primary" style="background-color: #ef6603; width: 100%;">
           Submit
            </button>
  </div>
