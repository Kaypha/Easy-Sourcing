...
<html>
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Last Quote Date</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$requestdata->dept}}</td>
      <td>{{$requestdata->item}}</td>
      <td>{{$requestdata->quantity}}</td>
      <td>{{$requestdata->desc}}</td>
      <td>{{$requestdata->quote_date}}</td>
      <td>@if($requestdata->status==0) Pending @else Approved @endif</td>
      <td> 
